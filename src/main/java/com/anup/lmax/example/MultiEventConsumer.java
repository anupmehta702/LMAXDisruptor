...
public class MultiEventConsumer implements EventConsumer {
    ...
    public EventHandler<ValueEvent>[] getEventHandler() {
        final EventHandler<ValueEvent> eventHandler = (event, sequence, endOfBatch) -> print(event, sequence,"firstConsumer");
        final EventHandler<ValueEvent> eventHandlerSecond = (event, sequence, endOfBatch) -> print(event, sequence,"secondConsumer");
